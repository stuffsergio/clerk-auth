...
export default function SignInPage() {
  ...
  return (
    <SignIn.Root>
      <SignIn.Step
        className="relative w-fit max-h-[50vh] mt-[25dvh] ml-[18dvw] flex flex-col gap-2 px-8 py-6 border rounded-md"
        name="start"
      >
        <h1 className="w-fit m-auto px-2 py-2">Sign In</h1>
        ...
        >
          ...
          <Clerk.FieldError>
            {({ message }) => {
              ...
              } else if (message?.includes("You have to use email address.")) {
